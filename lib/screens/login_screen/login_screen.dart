                            ...
                            child: Form(
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Center(child: Text(ConstantStrings.Login,style: TextDecorations.getBoldTextStyle(context,fontSize: 22.0,color: ColorResources.getPrimaryColor(context)),)),
                                    SizedBox(height: 16,),
                                    Column(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              focusedBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: ColorResources.getPrimaryColorLight(context),
                                                ),
                                                borderRadius:
                                    ...
                                    MaterialButton(
                                      ...
                                      onPressed: (){
                                        ...
                                        if(_password.isEmpty){
                                          Fluttertoast.showToast(msg: "Password can't be empty.",backgroundColor: Colors.redAccent,);
                                          return;
                                        }

                                        firebaseProvider.login(_email, _password).then((status){
                                          if(status.isSuccess){
                                            //successful

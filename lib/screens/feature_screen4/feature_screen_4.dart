...
class FeatureScreen4 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return _FeatureScreen4State();
  }

}

class _FeatureScreen4State extends State<FeatureScreen4>{
                  ...
                  child: Consumer<NotificationProvider>(
                    builder: (context,notificationProvider,child) =>Column(
                      ...
                      children: [
                        ...
                        Center(child: Text("4",style: TextDecorations.getBoldTextStyle(context,fontSize: 22.0,color: ColorResources.getPrimaryColor(context)),)),

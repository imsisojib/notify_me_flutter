...
class ColorResources {
  ...
  static Color getPrimaryColor(BuildContext context){
    return Provider.of<ThemeProvider>(context).darkTheme ? primaryColor : primaryColor;
  }

  static Color getPrimaryColorDark(BuildContext context){
    return Provider.of<ThemeProvider>(context).darkTheme ? primaryColorDark : primaryColorDark;
  }

  static Color getPrimaryColorLight(BuildContext context){
    return Provider.of<ThemeProvider>(context).darkTheme ? primaryColorLight : primaryColorLight;
  }

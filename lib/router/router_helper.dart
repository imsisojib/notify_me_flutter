...
//*******Handlers*********
  ...
  static final Handler _welcomeScreenHandler = new Handler(handlerFunc: (context, Map<String, dynamic> params) => WelcomeScreen());
...
//*******Route Define*********
  static void setupRouter() {
    ...
    router.define(Routes.WELCOME_SCREEN, handler: _welcomeScreenHandler, transitionType: TransitionType.fadeIn);
